    ...
    <div className="animate-in fade-in duration-700">
      <section className="px-6 py-16 md:py-24 max-w-7xl mx-auto">
        <div className="max-w-3xl mb-16 md:mb-24">
          ...
          <h1 className="text-3xl md:text-5xl font-semibold text-slate-900 mb-6 tracking-tight">Proven. Repeatable. Minimal Disruption.</h1>
        ...
        <div className="mt-16 md:mt-24 bg-slate-900 text-white p-8 md:p-12 rounded-lg flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <div className="mb-8 md:mb-0 max-w-lg">
            <h3 className="text-xl md:text-2xl font-semibold mb-4">A one-time operational upgrade.</h3>
            <p className="text-slate-400 text-sm font-light">Unlike marketing services, once Effito is installed, it is yours. It works every day, month after month.</p>
          </div>
