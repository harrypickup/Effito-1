  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      <section className="px-6 py-16 md:py-24 max-w-7xl mx-auto">
        ...
        {/* Hidden H2 for SEO section identification */}
        <h2 className="sr-only">Core Industry Challenges</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 border-t border-stone-200 pt-12 md:pt-16">
          {deepDives.map((item, idx) => (
            <div key={idx}>
              {/* H3: Correct nesting for the list items */}
        ...
        <div className="mt-16 md:mt-24 p-8 md:p-12 bg-stone-100 rounded-lg text-center border border-stone-200">
          {/* H2: Applied to the closing statement/quote */}
          <h2 className="text-xl md:text-2xl font-medium text-slate-800 italic text-balance">
