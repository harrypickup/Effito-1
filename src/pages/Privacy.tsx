...
const Privacy: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Effito</title>
        <meta name="description" content="Read Effito's privacy policy covering data collection, usage, and protection for care home operators using our growth infrastructure platform." />
      </Helmet>
